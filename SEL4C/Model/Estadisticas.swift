...
extension Estadisticas {
    ...
    static func fetchEstadisticasDetail(idUsuario: Int) async throws -> Estadisticas {
        let baseString = "http://34.230.9.105:8000/api/user/progress/bars/\(idUsuario)/"
...
class EstadisticasPost{
    let baseString = "http://34.230.9.105:8000/api/admin/estadisticas/create/"
...
class EstadisticasPut {
    let baseString = "http://34.230.9.105:8000/api/user/progress/bars/"
